...
describe('Component OrderOption', () => {
  ...
  it('should display props name in content title', () => {
...
for(let type in optionTypes){
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    switch (type) {
      case 'dropdown': {
        /* tests for dropdown */
        it('should render contains select and options', () => {
      ...
      case 'icons': {
        it('should render div with icon class', () => {
      ...
      case 'checkboxes': {
        it('should render div with checkboxes class', () => {
      ...
      case 'number': {
        ...
        it('should run function after change', () => {
